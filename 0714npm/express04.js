...
app.use((req,res)=>{
    ...
    //userAgent => 사용자 에이전트의 애플리케이션, 운영체체, 공급업체 및 / 또는 버전을 식별할 수 있도록 하는 특성 문자열


    //GET => 웹서버 주소 뒤에 변수값을 전달 방식 / POST => body안에서 폼문을 사용 전달 방식
    //http://127.0.0.1:3000/?userid=apple    
    const paraName = req.query.userid;//GET방식으로 변수값을 가져옴
